...
date: "3/13/2023"
description: "Text analysis of scripts from the TV series Seinfeld"
categories: [sentiment, text analysis]
format: html
editor: visual
---
...
[![](visuals/01-seinfeld-sentiment.png){width="70%"}](https://github.com/bradfordjohnson/seinfeld-analysis/blob/main/scripts/sentiment/06-visualize-sentiment.R)
...
[![](visuals/02-seinfeld-bigrams.png){width="70%"}](https://github.com/bradfordjohnson/seinfeld-analysis/blob/main/scripts/grams/03-visualize-bi.R)
